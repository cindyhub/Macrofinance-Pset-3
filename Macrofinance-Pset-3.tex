...
\end{aligned}\]
Using our expression for $P_t$ from (c), we can therefore write the relation between $\mu_{P, t}$ and $\sigma_{P, t }$ in state variables as:
\[
    \frac{Y_t(\eta_t - 1 + \frac{\rho}{\rho^h})}{\frac{Y_{t} + L_t}{\rho^{\mathrm{h}}}\eta_t} + \mu_{P, t} - r_t = \frac{\frac{Y_{t} + L_t}{\rho^{\mathrm{h}}}\eta_t(\sigma_{P, t})^2}{\eta_t - 1 + \frac{\rho}{\rho^h}}
\]
